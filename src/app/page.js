...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "Real-time AI chat app with a comedic procrastination coach personality. with WebSocket communication, persistent conversation memory, and OpenAI integration.",
